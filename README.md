...
- **Documents** — field-ready printouts generated from the trial: a large **field map** (colour-by
  treatment/rep/block) and a one-page **trial summary** (metadata, site details, treatments & rates,
  application schedule with actual dates, assessment plan, and an embedded field map). Each renders
  clean via print CSS and exports to PDF.
